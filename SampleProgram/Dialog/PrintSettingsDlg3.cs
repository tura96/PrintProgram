...
namespace SampleProgram
{
    ...
    /// </summary>
    public partial class PrintSettingsDlg3 : Form
    {
        #region Fields
        ...
        public PrintSettingsDlg3(String devName, String portName)
        {
            InitializeComponent();
        ...
        private void UpdateMediaLayoutComboBox()
        {
            try
            {
                ...
                _mediaLayoutList = EPDMControl.GetInstance().GetMediaLayoutList_3(out index);
