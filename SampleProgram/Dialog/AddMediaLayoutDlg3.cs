...
namespace SampleProgram
{
    ...
    /// </summary>
    public partial class AddMediaLayoutDlg3 : Form
    {
        #region Fields
        ...
        public AddMediaLayoutDlg3(String devName, String portName)
        {
            InitializeComponent();
        ...
        /// <summary>
        /// This is the event handler that load AddMediaLayoutDlg3. 
        /// </summary>
        private void AddMediaLayoutDlg3_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                EPDMControl.GetInstance().AddMediaLayout_3(MediaLayoutNameTextBox.Text, labelWidth, labelLength);
            }
            catch (EPDMException ex)
            {
                MessageString.GetEPDMError((int)ex.ErrCode, MessageString.STATE_MEDIA_LAYOUT_ERROR);
        ...
        private void UpdateMediaLayoutRangeString()
        {
            try
            {
                MEDIA_LAYOUT_RANGE obj = EPDMControl.GetInstance().GetMediaLayoutRangeValue_3();
